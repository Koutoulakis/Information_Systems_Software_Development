...
${OBJECTDIR}/core_impl.o: core_impl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core_impl.o core_impl.c

${OBJECTDIR}/defn_impl.o: defn_impl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/defn_impl.o defn_impl.c

${OBJECTDIR}/hash_table_func.o: hash_table_func.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hash_table_func.o hash_table_func.c

${OBJECTDIR}/index_impl.o: index_impl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/index_impl.o index_impl.c

${OBJECTDIR}/index_test_main.o: index_test_main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/index_test_main.o index_test_main.c

${OBJECTDIR}/my_cache_func.o: my_cache_func.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/my_cache_func.o my_cache_func.c

${OBJECTDIR}/my_core_func.o: my_core_func.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/my_core_func.o my_core_func.c

${OBJECTDIR}/test_data_main.o: test_data_main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_data_main.o test_data_main.c

${OBJECTDIR}/test_main.o: test_main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_main.o test_main.c

${OBJECTDIR}/threads_func.o: threads_func.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/threads_func.o threads_func.c
